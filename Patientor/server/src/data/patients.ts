    ...
    entries: [
      {
        ...
        diagnosisCodes: ['Z57.1', 'Z74.3', 'M51.2'],
        description:
          'Patient started to see double after breaking the Enigma Code. Advised bed rest until issue has resolved.',
        sickLeave: {
          startDate: '1943-08-05',
          endDate: '1943-08-28',
        },
      },
    ],
